...
exports.widthPropType =
  exports.roundPropType =
  exports.pointPropType =
  exports.patternPropType =
  exports.padPropType =
  exports.marginProp =
  exports.hoverIndicatorPropType =
  exports.heightPropType =
  exports.genericProps =
  exports.elevationPropType =
  exports.colorPropType =
  exports.backgroundPropType =
  exports.backgroundDoc =
  exports.alignPropType =
  exports.a11yTitlePropType =
  exports.OVERFLOW_VALUES =
  exports.MARGIN_SIZES =
    void 0;
...
var alignPropType = _propTypes['default'].oneOfType([
...
var colorPropType = _propTypes['default'].oneOfType([
  _propTypes['default'].string,
...
var backgroundPropType = _propTypes['default'].oneOfType([
  _propTypes['default'].string,
  _propTypes['default'].shape({
    color: colorPropType,
    dark: _propTypes['default'].oneOfType([
      _propTypes['default'].bool,
      _propTypes['default'].string,
    ]),
    image: _propTypes['default'].string,
    position: _propTypes['default'].string,
    opacity: _propTypes['default'].oneOfType([
      _propTypes['default'].string,
      _propTypes['default'].bool,
      _propTypes['default'].number,
      _propTypes['default'].oneOf(['weak', 'medium', 'strong']),
    ]),
    repeat: _propTypes['default'].oneOfType([
      _propTypes['default'].oneOf(['no-repeat', 'repeat']),
      _propTypes['default'].string,
    ]),
    size: _propTypes['default'].oneOfType([
      _propTypes['default'].oneOf(['cover', 'contain']),
      _propTypes['default'].string,
    ]),
    light: _propTypes['default'].string,
  }),
...
var marginProp = _propTypes['default'].oneOfType([
  _propTypes['default'].oneOf(['none'].concat(MARGIN_SIZES)),
  _propTypes['default'].shape({
    bottom: _propTypes['default'].oneOfType([
      _propTypes['default'].oneOf(MARGIN_SIZES),
      _propTypes['default'].string,
    ]),
    ...
    start: _propTypes['default'].oneOfType([
      _propTypes['default'].oneOf(MARGIN_SIZES),
      _propTypes['default'].string,
    ]),
...
var padPropType = _propTypes['default'].oneOfType([
  _propTypes['default'].oneOf(['none'].concat(PAD_SIZES)),
  _propTypes['default'].shape({
    bottom: _propTypes['default'].oneOfType([
      _propTypes['default'].oneOf(PAD_SIZES),
      _propTypes['default'].string,
    ]),
    end: _propTypes['default'].oneOfType([
      _propTypes['default'].oneOf(PAD_SIZES),
...
var elevationPropType = _propTypes['default'].oneOfType([
  _propTypes['default'].oneOf([
    'none',
    'xsmall',
    'small',
...
var hoverIndicatorPropType = _propTypes['default'].oneOfType([
  _propTypes['default'].bool,
  _propTypes['default'].string,
  _propTypes['default'].oneOf(['background']),
  backgroundPropType,
  _propTypes['default'].shape({
...
var pointPropType = _propTypes['default'].oneOf([
  'circle',
  'diamond',
  'square',
  'star',
...
var patternPropType = _propTypes['default'].oneOf([
  'squares',
  'circles',
  'stripesHorizontal',
  'stripesVertical',
...
var roundPropType = _propTypes['default'].oneOfType([
  _propTypes['default'].bool,
  _propTypes['default'].oneOf([
    'xsmall',
    'small',
  ...
  _propTypes['default'].string,
  _propTypes['default'].shape({
    corner: _propTypes['default'].oneOf([
      'top',
      'left',
      'bottom',
      'right',
...
var dimSizeType = _propTypes['default'].oneOf([
  'xxsmall',
  'xsmall',
  'small',
  'medium',
...
var heightPropType = _propTypes['default'].oneOfType([
  dimSizeType,
  _propTypes['default'].string,
  _propTypes['default'].shape({
...
var widthPropType = _propTypes['default'].oneOfType([
  dimSizeType,
  _propTypes['default'].string,
  _propTypes['default'].shape({
