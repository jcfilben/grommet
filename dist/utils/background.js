...
exports.selectedStyle =
  exports.normalizeBackground =
  exports.getHoverIndicatorStyle =
  exports.backgroundStyle =
  exports.backgroundIsDark =
  exports.backgroundAndTextColors =
  exports.activeStyle =
    void 0;
...
var backgroundAndTextColors = function backgroundAndTextColors(
  backgroundArg,
  textArg,
  theme,
) {
  ...
  if (typeof background === 'object') {
    ...
    if (background.color) {
      var color = (0, _colors.normalizeColor)(
        background.color,
        theme,
        background.dark,
      );
      ...
      if (!textColor && (opacity === undefined || opacity > 0.3)) {
        ...
        textColor = (0, _colors.normalizeColor)(
...
var activeStyle = (0, _styledComponents.css)(
  _templateObject5 ||
...
var selectedStyle = (0, _styledComponents.css)(
  _templateObject6 ||
