    ...
    (date == null
      ...
      : date.map(function (item) {
          ...
          if (!Array.isArray(item)) {
            ...
            var start =
              item[0] !== undefined
                ? (0, _utils.formatToLocalYYYYMMDD)(item[0])
                : 'none';
            var end =
              item[1] !== undefined
                ? (0, _utils.formatToLocalYYYYMMDD)(item[1])
                : 'none';
...
var getAccessibilityString = function getAccessibilityString(date, dates) {
  if (date && !Array.isArray(date)) {
    return (
      'Currently selected ' + (0, _utils.formatToLocalYYYYMMDD)(date) + ';'
    );
  }
...
var Calendar = /*#__PURE__*/ (0, _react.forwardRef)(function (_ref3, ref) {
              ...
              CalendarDay,
              {
                ...
                buttonProps: {
                  ...
                  onClick: function onClick() {
                    ...
                    announce(
                      'Selected ' +
                        (0, _utils.formatToLocalYYYYMMDD)(dateString),
                      'assertive',
  ...
  weeks.push(
    /*#__PURE__*/ _react['default'].createElement(
      _StyledCalendar.StyledWeek, // if a week contains only blank days, for screen reader accessibility
      ...
      /*#__PURE__*/ _react['default'].createElement(
        _Keyboard.Keyboard,
        {
          ...
          onUp: function onUp(event) {
            ...
            if (
              !(0, _utils.betweenDates)(
                (0, _utils.addDays)(active, -7),
                displayBounds,
              )
            ) {
