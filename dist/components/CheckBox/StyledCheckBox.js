...
exports.StyledCheckBoxToggle =
  exports.StyledCheckBoxKnob =
  exports.StyledCheckBoxInput =
  exports.StyledCheckBoxIcon =
  exports.StyledCheckBoxContainer =
  exports.StyledCheckBoxBox =
  exports.StyledCheckBox =
    void 0;
...
var hoverStyle = (0, _styledComponents.css)(
  ...
  function (props) {
    ...
    return (0, _utils.normalizeColor)(
      (_props$theme$checkBox = props.theme.checkBox.hover) == null
        ? void 0
        : (_props$theme$checkBox2 = _props$theme$checkBox.border) == null
        ? void 0
        : _props$theme$checkBox2.color,
      props.theme,
    );
  },
  function (props) {
    ...
    return (0, _utils.normalizeColor)(
      !props.disabled &&
        ((_props$theme$checkBox3 = props.theme.checkBox.hover) == null
          ? void 0
          : (_props$theme$checkBox4 = _props$theme$checkBox3.background) == null
          ? void 0
          : _props$theme$checkBox4.color),
      props.theme,
    );
  },
);

var StyledCheckBoxIcon = _styledComponents['default'].svg(
  _templateObject2 ||
...
var StyledCheckBoxContainer = _styledComponents['default'].label(
  _templateObject3 ||
  ...
  hoverStyle,
  function (props) {
    var _props$theme$checkBox5,
      _props$theme$checkBox6,
      _props$theme$checkBox7,
      _props$theme$checkBox8;
    ...
    return (
      ...
      '\n    input:not([disabled]) + div,\n    input:not([disabled]) + span {\n      border-color: ' +
        (0, _utils.normalizeColor)(
          (_props$theme$checkBox5 = props.theme.checkBox.hover) == null
            ? void 0
            : (_props$theme$checkBox6 = _props$theme$checkBox5.border) == null
            ? void 0
            : _props$theme$checkBox6.color,
          props.theme,
        ) +
        ';\n    }\n     \n    background-color: ' +
        (0, _utils.normalizeColor)(
          !props.disabled &&
            ((_props$theme$checkBox7 = props.theme.checkBox.hover) == null
              ? void 0
              : (_props$theme$checkBox8 = _props$theme$checkBox7.background) ==
                null
              ? void 0
              : _props$theme$checkBox8.color),
          props.theme,
        ) +
        ';'
    );
...
var StyledCheckBoxInput = _styledComponents['default'].input(
  _templateObject4 ||
...
var StyledCheckBoxBox = _styledComponents['default'].div(
  _templateObject5 ||
...
var StyledCheckBoxToggle = _styledComponents['default'].span(
  _templateObject6 ||
...
var StyledCheckBoxKnob = _styledComponents['default'].span(
  _templateObject7 ||
...
var StyledCheckBox = _styledComponents['default'].div(
  _templateObject8 ||
