...
var FileInput = /*#__PURE__*/ (0, _react.forwardRef)(function (_ref, ref) {
  ...
  if (removeRef.current && controlRef.current) {
    ...
    if (rightPad && typeof rightPad === 'string')
      rightOffset = rightOffsetRemove + (0, _utils.parseMetricToNum)(rightPad);

    if (files.length === 1 || files.length > aggregateThreshold) {
      rightOffset =
        rightOffsetBrowse +
        rightOffsetRemove +
        (0, _utils.parseMetricToNum)(theme.global.edgeSize.small) * 2;
  ...
  return /*#__PURE__*/ _react['default'].createElement(
        ...
        files.map(function (file, index) {
          return /*#__PURE__*/ _react['default'].createElement(
            ...
            renderFile
              ...
              : /*#__PURE__*/ _react['default'].createElement(
                  _Box.Box,
                  _extends({}, theme.fileInput.label, {
                    gap: 'xsmall',
                    align: 'center',
                    direction: 'row',
                  }),
    ...
    showRemoveConfirmation &&
      /*#__PURE__*/ _react['default'].createElement(ConfirmRemove, {
