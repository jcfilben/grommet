...
exports.valuesAreEqual =
  exports.valueToText =
  exports.textToValue =
  exports.schemaToMask =
  exports.formatToSchema =
    void 0;
  ...
  schema.every(function (part) {
    ...
    while (
      ...
      (Number.isNaN(dates[dateIndex].date) ||
        ((_char2 === 'm' || _char2 === 'd' || _char2 === 'y') && parts[part]))
    ) {
      dateIndex += 1;
      parts = {};
    }
...
var textToValue = function textToValue(text, schema, valueProp, range) {
  ...
  var addDate = function addDate(parts) {
    var leapYear =
      (parts.y % 4 === 0 && parts.y % 100 !== 0) || parts.y % 400 === 0; // Do a little sanity checking on the parts first.
