...
var data = {
  ...
  'Request created by': /*#__PURE__*/ _react['default'].createElement(
    _grommet.Anchor,
    {
  ...
  Description:
    'Full-service AI insights, security and unified infrastructure \n  management for campus, branch, remote, and data center networks',
};
exports.data = data;
var metricData = {
